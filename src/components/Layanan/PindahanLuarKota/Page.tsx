...
export default function PindahanLuarKotaComponent({ benefitFullService, benefitMiddleService, benefitTruckingService }: { benefitFullService: string[], benefitMiddleService: string[], benefitTruckingService: string[] }) {
