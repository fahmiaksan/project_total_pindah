...
export default function PindahanRumahComponent({ benefitFullServicePackage, benefitBisnisPackage, benefitEconomiPackage, serviceSchema }: { benefitFullServicePackage: string[], benefitBisnisPackage: string[], benefitEconomiPackage: string[], serviceSchema: any }) {
  return (
    <Layout
